...
FlashPayloadLayout BuildPayloadLayoutForVoicing(const std::vector<std::uint8_t>& bytes,
                                                const BfskConfig& config,
                                                FlashVoicingFlavor flavor);

std::vector<std::int16_t> EncodePayloadLayoutToPcm16(const FlashPayloadLayout& layout,
                                                     const BfskConfig& config = {},
